...
#endif
#include <iostream>
class Top1_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Top1_api_t(VTop1* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Top1.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VTop1* top = new VTop1;
    std::string vcdfile = "test_run_dir/examples/Top1/Top1.vcd";
